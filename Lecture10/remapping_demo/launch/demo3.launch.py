...
def generate_launch_description():
    ...
    right_camera_node = Node(
        ...
        name="right_camera",
        remappings=[("/camera/image_color", "/right_camera/image_color")],
        output="screen",
        emulate_tty=True,
    )
    ...
    left_camera_node = Node(
        ...
        executable="camera_demo",
        name="left_camera",
        remappings=[("/camera/image_color", "/left_camera/image_color")],
        output="screen",
        emulate_tty=True,
    )
    ...
    rear_camera_node = Node(
        ...
        executable="camera_demo",
        name="rear_camera",
        remappings=[("/camera/image_color", "/rear_camera/image_color")],
        output="screen",
        emulate_tty=True,
    )
